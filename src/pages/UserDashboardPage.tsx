...
export function UserDashboardPage() {
    ...
    const handleGoToReturnDetail = (scheduleId: number, clubId: number) => {
        // 상세 페이지로 이동하며 scheduleId와 clubId를 state로 전달
        navigate('/return-detail', { state: { scheduleId, clubId } });
    }; 
                                    ...
                                    <div key={schedule.id} className="asset-card">
                                        ...
                                        {schedule.status === 'in_use' && (
                                            <button
                                                ...
                                                onClick={() => handleGoToReturnDetail(schedule.id, schedule.club_id)}
                                            >
                                                반납하기
                                            </button>
                                        )}
